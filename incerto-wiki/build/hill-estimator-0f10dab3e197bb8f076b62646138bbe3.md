...
ax.semilogx(pure["k"], pure["alpha"], color="#28724f", lw=2, label="exact Pareto")
ax.semilogx(
    body_tail["k"],
    body_tail["alpha"],
    color="#a34d2d",
...
ax.axhline(alpha, color="#1b365d", ls="--", lw=1.5, label="true alpha")
...
print(round(hill_alpha_estimator(pure_sample, k=500), 3))
```
